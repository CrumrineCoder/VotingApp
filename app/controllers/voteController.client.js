...
window.onload = function() {
    ...
    function editPoll(data) {
        ...
        document.getElementById('question').innerHTML = "Question: " + pollObject[page].question;
        ...
        document.getElementById("Notes").setAttribute('size', document.getElementById("Notes").getAttribute('placeholder').length);
